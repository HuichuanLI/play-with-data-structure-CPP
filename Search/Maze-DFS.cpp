...
int res[1002][2];
int n, head, tail, resTurns = INT_MAX, stateCount = 0;
...
int main() {
    ...
    ifstream fin("/Users/lhc456/Desktop/c++/play-with-data-structure-CPP/Search/data/dfs/3.in");
    cout.tie(NULL);
